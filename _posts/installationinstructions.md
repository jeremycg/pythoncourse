...
![png](/assets/install/installationinstructions_27_0.png)
...
[https://raw.githubusercontent.com/jeremycg/pythoncourse/gh-
pages/assets/install/notebook.zip], unzip, then open ipython-notebook. It should
launch a browser window pointing to http://localhost:8888/tree if not, click the
link to open it:
...
![png](/assets/install/installationinstructions_36_0.png)
